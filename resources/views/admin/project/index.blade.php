    ...
    <div class="row mt-3">
        <div class="col-lg-12">
            <div class="card">
                ...
                @endif
                    <form class="form-horizontal p-t-20" method="POST" action="{{route('add.project')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="title" id="exampleInputuname4" placeholder="Enter your Project title">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInputuname4" class="col-sm-3 control-label">Project Description<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <textarea type="text" class="form-control" name="description" id="exampleInputuname4" placeholder="Enter Project Description Within 350 Words"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInputuname4" class="col-sm-3 control-label">Tools & Technologies<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <textarea type="text" class="form-control" name="tool_technology" id="exampleInputuname4" placeholder="Enter Tools & Technologies Within 350 Words"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInputuname4" class="col-sm-3 control-label">Project Link<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="project_link" id="exampleInputuname4" placeholder="Enter your Project Link">
                            </div>
                        </div>
                        <div class="form-group row">
