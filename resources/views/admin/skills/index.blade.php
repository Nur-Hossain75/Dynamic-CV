    ...
    <div class="row mt-3">
        <div class="col-lg-12">
            <div class="card">
                ...
                @endif
                    <form class="form-horizontal p-t-20" method="POST" action="{{route('add.skill')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="exampleInputuname4" class="col-sm-3 control-label">Skill Name<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="skill" id="exampleInputuname4" placeholder="Enter your Skill Name">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row m-b-0">
                            <div class="offset-sm-3 col-sm-9">
                                <button type="submit" class="btn btn-success waves-effect waves-light text-white">Create New Skill</button>
                            </div>
                        </div>
                    </form>
                </div>
