    ...
    <div class="row mt-3">
        <div class="col-lg-12">
            <div class="card">
                ...
                @endif
                    <form class="form-horizontal p-t-20" method="POST" action="{{route('add.certificate')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label for="exampleInputuname4" class="col-sm-3 control-label">Certificate Title<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name" id="exampleInputuname4" placeholder="Enter your certificate title">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInputuname4" class="col-sm-3 control-label">Certificate Description<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <textarea type="text" class="form-control" name="description" id="exampleInputuname4" placeholder="Enter Certificate Description Within 100 Words"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
