    ...
    <div class="row mt-3">
        <div class="col-lg-12">
            <div class="card">
                ...
                @endif
                    <form class="form-horizontal p-t-20" method="POST" action="{{route('add.contact')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label for="exampleInputuname4" class="col-sm-3 control-label">Contact Title<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="contact_title" id="exampleInputuname4" placeholder="Enter your contact title">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInputuname4" class="col-sm-3 control-label">Contact Informaion<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="contact_info" id="exampleInputuname4" placeholder="Enter your contact number/email/social link (git/linkdin etc)">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInputuname4" class="col-sm-3 control-label">Priority<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="contact_pritory" id="exampleInputuname4" placeholder="Priority to show your info">
                            </div>
                        </div>
                        <div class="form-group row">
